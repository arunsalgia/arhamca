	...
	function DisplayAllPayment() {
		...
		return (
			...
			<TableRow key="header" align="center">
				<TableCell className={gClasses.th} p={0} align="center">Batch Code</TableCell>
			...
			<TableBody p={0}>
				{paymentArray.map(x => {
					...
					return (
					<TableRow key={x.bid} >
						<TableCell className={myClasses} align="center" p={0}  >{x.bid}</TableCell>
	...
	<div>
		...
		<Grid key="REPORTINCOMEDATE" className={gClasses.noPadding} container >
			...
			<Grid item xs={2} sm={2} md={2} lg={1} >
				<Typography align="left"  className={gClasses.info18Blue} >Month</Typography>
			</Grid>
