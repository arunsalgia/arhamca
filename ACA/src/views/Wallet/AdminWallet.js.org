...
//var searchText = "";
//function setSearchText(txt) { searchText = txt; }
...
export default function AdminWallet() {
  ...
  function ShowResisterStatus() {
    ...
    switch (registerStatus) {
      ...
      break;			
			case 2000:
				myMsg = 'Successfully added amount in users wallet';
				errmsg = false;
      case 0:
        myMsg = ``;
        errmsg = false;
    ...
    //var myURL = `${process.env.REACT_APP_AXIOS_BASEPATH}/wallet/addadminwallet/${paymentRequest}/${paymentId}`;
		...
		var uidListStr = 245; //uidList.toString();
		console.log(uidListStr);
		
    try {
			var myUrl = `${process.env.REACT_APP_AXIOS_BASEPATH}/wallet/addadminwallet/${uidListStr}/${amount}`;
			console.log(myUrl);
