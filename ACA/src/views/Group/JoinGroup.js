  ...
  return (
    ...
    <ValidatorForm className={gClasses.form} onSubmit={handleSubmit}>
      ...
      <div align="center">
            ...
            className={gClasses.button}>Submit
			</Button>*/}
			<VsButton name="Join" disabled={groupCode === ""}  type="submit" />
      </div>
    </ValidatorForm>
    ...
    >
      ...
      <BlankArea />
      <div align="center" >
			<VsButton align="center" name={insufficientAmount ? "Add to Wallet" : "Confirm Group Join" } onClick={handleConfirm} />
				{/*<Button key="modalbutton" variant="contained" color="primary" size="medium"
        className={gClasses.dashButton} onClick={handleConfirm}>
